...
const roleLable = 'Teaching For'
const role = [
    {
        id: 1,
        option: 'Select either for childern or for adults'
    },
    {
        id: 2,
        option: 'Teaching for Childern'
    },
    {
        id: 3,
        option: 'Teaching for Adult'
    }
]
const EducatorForm = ({title}) => {
    return (
